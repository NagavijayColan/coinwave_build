...
var PortfolioComponent = /** @class */ (function () {
    ...
    PortfolioComponent.prototype.getPortfolioList = function () {
        ...
        if (localStorage.getItem('userToken') && this.clearInterval) {
            var tokenV = localStorage.getItem('userToken');
            this.runningInterval = this.http.post('http://172.31.53.92:5687/api/coins/getPortfolio', { token: tokenV }).map(function (response) { return response.json(); }).subscribe(function (data) {
