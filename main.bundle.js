    ...
    CoinlistComponent.prototype.advancedSearchFilter = function () {
        ...
        if (this.advFilter.length > 0) {
            ...
            this.http.post('http://18.191.202.171:5687/exchange/getusd', { filter: this.advFilter, from: 0, to: 1500 }).map(function (response) { return response.json(); }).
                ...
                console.log(err);
                var array = [];
                _this.component1.advancedTableFilter(array);
            });
        }
    };
    __decorate([
...
var PortfolioComponent = /** @class */ (function () {
    ...
    PortfolioComponent.prototype.ngOnInit = function () {
        this.coinList = [{
                "price": 0.029929972509528,
                "pair": "accusd",
                "volume": 40260.51890656,
                "low": 0.024298817887889998,
                "high": 0.037181048323692,
                "dayPricePercent": 0,
                "dayPrice": 0.002976963073442182,
                "dayPriceStatus": "NC",
                "priceStatus": "false",
                "weeklyChangeStatus": "false",
                "weeklyChange": 0.009999999999999998,
                "weeklyChangePercent": "1.5",
                "highestPrice": 0.0282041766239561,
                "lowestPrice": 0.025675731895102864,
                "dayVolume": 13049.30939732049,
                "name": "AdCoin",
                "image": "adcoin.png",
                "marketCapValue": 0
            }, {
                "price": 0.06595393426712999,
                "pair": "8bitusd",
                "volume": 0,
                "low": 0.06595393426712999,
                "high": 0.06595393426712999,
                "dayPricePercent": 1.1666666666666667,
                "dayPrice": 0.0077857590068011046,
                "dayPriceStatus": "false",
                "priceStatus": "false",
                "weeklyChangeStatus": "NC",
                "weeklyChange": 0,
                "weeklyChangePercent": "0",
                "highestPrice": 0.07847129328924107,
                "lowestPrice": 0.07336758877574848,
                "dayVolume": 1117.4757441369943,
                "name": "8BIT Coin",
                "image": "8bitcoin.jpg",
                "marketCapValue": 0
            }, {
                "price": 34.92943500518527,
                "pair": "abcusd",
                "volume": 3.18861634,
                "low": 33.32594444189775,
                "high": 34.92943500518527,
                "dayPricePercent": 1.009163802978236,
                "dayPrice": 0.3123247655711552,
                "dayPriceStatus": "false",
                "priceStatus": "false",
                "weeklyChangeStatus": "false",
                "weeklyChange": 3.8200000000000003,
                "weeklyChangePercent": "1.109392898052692",
                "highestPrice": 35.2549206649168,
                "lowestPrice": 35.208950352899365,
                "dayVolume": 2.2119183825421347,
                "name": "AB-Chain",
                "image": "abchain.png",
                "marketCapValue": 0
            }, {
                "price": 0.00046283462643599994,
                "pair": "lanausd",
                "volume": 281310.13211673,
                "low": 0.00038569552203,
                "high": 0.00046283462643599994,
                "dayPricePercent": 0,
                "dayPrice": 0.000012297813068867314,
                "dayPriceStatus": "NC",
                "priceStatus": "false",
                "weeklyChangeStatus": "NC",
                "weeklyChange": 0,
                "weeklyChangePercent": "0",
                "highestPrice": 0.0005301837994424916,
                "lowestPrice": 0.0004073509957540372,
                "dayVolume": 68665.55893694983,
                "name": "LanaCoin",
                "image": "lanacoin.png",
                "marketCapValue": 0
            }, {
                "price": 19670.471700669106,
                "pair": "42usd",
                "volume": 0.00427148,
                "low": 19670.471700669106,
                "high": 20271.13747604939,
                "dayPricePercent": 1.1708505185692055,
                "dayPrice": 3360.710276091344,
                "dayPriceStatus": "false",
                "priceStatus": "false",
                "weeklyChangeStatus": "false",
                "weeklyChange": 2836.119999999999,
                "weeklyChangePercent": "1.1441816082686382",
                "highestPrice": 23089.903676480393,
                "lowestPrice": 22259.187029569483,
                "dayVolume": 0.0016850724578651687,
                "name": "42 Coin",
                "image": "42coin.png",
                "marketCapValue": 0
            }];
    ...
    PortfolioComponent.prototype.getPortfolioList = function () {
        ...
        if (localStorage.getItem('userToken') && this.clearInterval) {
            var tokenV = localStorage.getItem('userToken');
            this.runningInterval = this.http.post('http://18.191.202.171:5687/api/coins/getPortfolio', { token: tokenV }).map(function (response) { return response.json(); }).subscribe(function (data) {
